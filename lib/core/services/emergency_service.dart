...
class EmergencyService extends ChangeNotifier {
  ...
  void _triggerCriticalAlert(EmergencySignal signal) {
    // Integration with notification service, sound and vibration
    // System channels would be invoked here in production.
    debugPrint('🚨 CRITICAL ALERT TRIGGERED: ${signal.message}');
    debugPrint('🔊 Playing loud emergency siren');
    debugPrint('📳 Vibrating device continuously');
  }
